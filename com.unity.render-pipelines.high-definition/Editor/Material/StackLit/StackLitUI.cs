...
{
    class StackLitGUI2 : BaseMaterialGUI
    {
        ...
        protected const string k_DiffusionProfileHash = "_DiffusionProfileHash";
        protected const string k_DiffusionProfileAsset = "_DiffusionProfileAsset";
        ...
        public StackLitGUI2()
        {
            ...
            _materialProperties = new GroupProperty(this, "_Material", new BaseProperty[]
            {
                ...
                {
                    new DiffusionProfileProperty(this, k_DiffusionProfileAsset, k_DiffusionProfileHash, "Diffusion Profile", "A profile determines the shape of the SSS/transmission filter.", false),
                ...
                {
                    new DiffusionProfileProperty(this, k_DiffusionProfileAsset, k_DiffusionProfileHash, "Diffusion Profile", "A profile determines the shape of the SSS/transmission filter.", false, _ => EnableSSS.BoolValue == false),
        ...
        public static void SetupMaterialKeywordsAndPass(Material material)
        {
            ...
            material.SetInt(kStencilRefMV, (int)HDRenderPipeline.StencilBitMask.ObjectMotionVectors);
            material.SetInt(kStencilWriteMaskMV, (int)HDRenderPipeline.StencilBitMask.ObjectMotionVectors);
