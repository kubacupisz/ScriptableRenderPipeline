...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    abstract class BaseMaterialGUI : BaseUnlitGUI
    {
        ...
        public class DiffusionProfileProperty : Property
        {
            ...
            public DiffusionProfileProperty(BaseMaterialGUI parent, string propertyName, string extraPropertyName, string guiText, string toolTip, bool isMandatory = true, Func<object, bool> isVisible = null)
                : base(parent, propertyName, guiText, toolTip, isMandatory, isVisible)
            {
            ...
            public override void OnGUI()
            {
                    ...
                    && (IsVisible == null || IsVisible(this)))
                {
                    ...
                    using (var scope = new EditorGUI.ChangeCheckScope())
                    {
                        ...
                        string guid = HDUtils.ConvertVector4ToGUID(VectorValue);
                        ...
                        using (var changeScope = new EditorGUI.ChangeCheckScope())
                        {
                            ...
                            if (changeScope.changed)
                            {
                                ...
                                VectorValue = newGuid;
                                m_ExtraProperty.floatValue = hash;
                            }
                        }
                    }
                }
