...
//custom-begin: trim variants, grafted from VFX/CaveWarp/Materials/Chunk_00.mat
    #define _ALPHATEST_ON
    #define _DISABLE_DECALS
    #define _DISABLE_SSR
    #define _DISPLACEMENT_LOCK_TILING_SCALE
    #define _EMISSIVE_COLOR_MAP
    #define _EMISSIVE_MAPPING_TRIPLANAR
    #define _HEIGHTMAP
    #define _MAPPING_TRIPLANAR
    #define _MASKMAP
    #define _NORMALMAP
    #define _NORMALMAP_TANGENT_SPACE
    #define _VERTEX_DISPLACEMENT
    #define _VERTEX_DISPLACEMENT_LOCK_OBJECT_SCALE
...
//custom-end
    ...
    SubShader
    {
        ...
        #if WARP2
            #include "Assets/VFX/CaveWarp/Shaders/CaveWarpFunctions.hlsl"
            #define LIT_SURFACE_DATA_MODIFIER CorridorWarpSurfaceData2
            #define LIT_BUILTIN_DATA_MODIFIER CorridorWarpBuiltinData2
        #endif
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/ShaderPass/LitSharePass.hlsl"
            #include "Packages/com.unity.render-pipelines.high-definition/Runtime/Material/Lit/LitData.hlsl"
