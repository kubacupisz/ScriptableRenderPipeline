...
//custom-begin: force instancing keyword
    // For some reason the PROCEDURAL_INSTANCING_ON keyword is not enabled,
    // even though instancing is enabled on the material.
    // #pragma multi_compile_instancing
    #define PROCEDURAL_INSTANCING_ON 1
    // Make HDRP happy
    #define UNITY_INSTANCING_PROCEDURAL_FUNC InstancingProceduralFunc
    void InstancingProceduralFunc(){}
//custom-end
...
//custom-begin
            ...
            #include "Assets/Code/Boston/Wires/Wires.hlsl"
#endif
//custom-end
