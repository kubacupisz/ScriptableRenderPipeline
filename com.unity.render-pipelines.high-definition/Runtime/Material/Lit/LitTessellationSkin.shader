Shader "HDRP/LitTessellationSkin"
{
    Properties
    {
...
//custom-begin: trim variants, grafted from Gawain_Arms__tesselation.mat
    ...
    #define _SUBSURFACE_MASK_MAP
    #define _TESSELLATION_PHONG
...
//custom-begin: add surface shader for animated skin (4D albedo + wrinkle maps)
            #define LIT_SURFACE_DATA_MODIFIER SkinSurf
            ...
            void SkinSurf(FragInputs input, inout SurfaceData surfaceData)
            {
                ...
                surfaceData.perceptualSmoothness *= cavityModulateSmoothness;
            }
//custom-end:
