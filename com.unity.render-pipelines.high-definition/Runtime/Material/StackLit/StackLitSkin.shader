...
//custom-begin: added missing toggle
...
//custom-begin: trim variants, grafted from Gawain_face__dual_lobe.mat
    #define _MATERIAL_FEATURE_DUAL_SPECULAR_LOBE
    #define _MATERIAL_FEATURE_SUBSURFACE_SCATTERING
    #define _MATERIAL_FEATURE_TRANSMISSION
    #define _USE_DETAILMAP

//original:
    //#pragma shader_feature_local _ALPHATEST_ON
    //#pragma shader_feature_local _DOUBLESIDED_ON

    //#pragma shader_feature_local _USE_DETAILMAP
    //#pragma shader_feature_local _USE_UV2
    //#pragma shader_feature_local _USE_UV3
    ...
    //#pragma shader_feature_local _MATERIAL_FEATURE_DUAL_SPECULAR_LOBE
    //#pragma shader_feature_local _MATERIAL_FEATURE_ANISOTROPY
    //#pragma shader_feature_local _MATERIAL_FEATURE_COAT
    //#pragma shader_feature_local _MATERIAL_FEATURE_COAT_NORMALMAP
    ...
    //#pragma shader_feature_local _VLAYERED_RECOMPUTE_PERLIGHT
    //#pragma shader_feature_local _VLAYERED_USE_REFRACTED_ANGLES_FOR_BASE


    //#pragma shader_feature_local _STACKLIT_DEBUG
//custom-end:
...
//custom-begin: add surface shader for animated skin (4D albedo + wrinkle maps)
            #define STACKLIT_SAMPLER_OVERRIDE s_linear_repeat_sampler// TODO remove this again if possible
            #define STACKLIT_SURFACE_DATA_MODIFIER SkinSurfNormal
...
//custom-begin: add surface shader for animated skin (4D albedo + wrinkle maps)
            ...
            float _CavitySpecularOcclusion;
            float _CavityModulateSmoothness;

            void SkinSurf(FragInputs input, inout SurfaceData surfaceData)
            {
                const float2 uv = input.texCoord0.xy;
                ...
                float3 tmpAlbedo = surfaceData.baseColor;
                ...
                //TODO blur decal should consider that normalData.perceptualRoughness is a blend of A and B...
                //surfaceData.perceptualSmoothnessA = 1.0 - normalData.perceptualRoughness;
                //surfaceData.perceptualSmoothnessB = 1.0 - normalData.perceptualRoughness;
                ...
                float cavity = tmpCavity;
                float cavityFadeTerm = lerp(1.0, geomFadeTerm, _CavityFresnelFade);
...
//custom-end:
    ...
    CustomEditor "Experimental.Rendering.HDPipeline.StackLitGUI2"
}
