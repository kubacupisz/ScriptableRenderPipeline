...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    public class DebugDisplaySettings : IDebugData
    {
        ...
        public void RegisterLightingDebug()
        {
            ...
            list.Add(new DebugUI.IntField { displayName = "Probe Volume Atlas Slice Index", getter = () => data.lightingDebugSettings.probeVolumeAtlasSliceIndex, setter = value => data.lightingDebugSettings.probeVolumeAtlasSliceIndex = value });
